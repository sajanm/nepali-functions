describe("sajan.nepaliFunctions", function () {
  ...
  it("should validate bs date", function () {
    ...
    var isBsDate = NepaliFunctions.BS.ValidateDate("2078/01/30", "YYYY/MM/DD");
    expect(isBsDate).toEqual(true);
  });
  ...
  it("should return number in words", function () {
    ...
    var words = NepaliFunctions.NumberToWords(12.6, true);
    expect(words).toEqual("Twelve Rupees and Sixty Paisa");

    var words = NepaliFunctions.NumberToWords(12.06, true);
    expect(words).toEqual("Twelve Rupees and Six Paisa");
  });
  ...
  it("should return number in words in unicode", function () {
    ...
    var words = NepaliFunctions.NumberToWordsUnicode(12.5, true);
    expect(words).toEqual("बाह्र रुपैंया पचास पैसा");

    var words = NepaliFunctions.NumberToWordsUnicode(12.05, true);
    expect(words).toEqual("बाह्र रुपैंया पाँच पैसा");
